...
$(document).ready(function(){
	...
	$('#libraryIdSelect').val('${param.libraryId}')
   ...
   $('#libraryIdSelect').on('change',function(){
	   document.location = "http://localhost/library?libraryId="+$('#libraryIdSelect').val();
   })
   ...
   $('#searchBtn').on('click',function(){
      ...
      location.href = "/library?libraryId="+libraryId+"&searchKeyword="+searched;
   })
   ...
   <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
         ...
         <div class="container-fluid">
            <!-- Page Heading -->
            <h2 class="h3 mb-2 text-gray-800" style="">
            	<i class="fas fa-folder-open" ></i>
             	<select style="width: 20%; border-color: transparent; background-color: transparent; display: inline-block;" class="form-control form-control-lg"
             		id="libraryIdSelect">
             		<c:forEach items="${libSelect }" var="libSel">
	             		<option value="${libSel.libraryId }">${libSel.libraryNm }</option>
             		</c:forEach>
             	</select>
            </h2>
            <br>

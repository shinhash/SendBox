...
<!--     <link rel="stylesheet" href="/css/organChartCSS/screen.css" /> -->
    ...
    <!-- Page level plugins -->
<%--     <script src="${pageContext.request.contextPath}/admin2form/vendor/chart.js/Chart.min.js"></script> --%>

    <!-- Page level custom scripts -->
<%--     <script src="${pageContext.request.contextPath}/admin2form/js/demo/chart-area-demo.js"></script> --%>
<%--     <script src="${pageContext.request.contextPath}/admin2form/js/demo/chart-pie-demo.js"></script> --%>

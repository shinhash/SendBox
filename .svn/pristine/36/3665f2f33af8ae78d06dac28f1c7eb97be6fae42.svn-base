	...
	<div id="demo" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item active">
				<!--가로-->
				<img class="d-block w-100" src="/images/signGuide.jpg"
					alt="First slide">
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/signGuide1.jpg"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>결재라인 설정</h5>
				</div>
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/signGuide2.jpg"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>결재라인 불러오기</h5>
					<p>결재양식 변경 가능</p>
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/signGuide3.jpg"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>결재선 추가</h5>
					<p>결재자 추가, 삭제, 정렬 가능</p>
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/signGuide4.png"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>문서 작성</h5>
					<p> 시행일자, 첨부파일 등록</p>
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/signGuide6.jpg"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>서류대기함</h5>
				</div>
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/signGuide10.png"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>문서 조회</h5>
					<p> pdf 및 한글파일 다운로드 가능</p>
				</div>
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/signGuide8.jpg"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>결재완료함</h5>
				</div>

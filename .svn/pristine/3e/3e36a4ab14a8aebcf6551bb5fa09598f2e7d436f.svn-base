				...
				if(eddedEmpDataArr.length > 0){
					$.ajax({
						...
						success	: function(data){
							empInfo = { empIdList : eddedEmpDataArr,    // 사원이 주소록에서 선택한 사원id 배열
										empNmList : eddedEmpNameArr}    // 사원이 주소록에서 선택한 사원이름 배열
							opener.chatInfoListReload(empInfo);
							self.close();
						},
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h2 class="h3 mb-2 text-gray-800"><i class="fas fa-address-book fa-fw" style="margin-left: 10px;"></i>&nbsp&nbsp 초대하기
                    </h2>
                        ...
                        <div class="card-header py-3">
                        	<div style="margin-left: 10px;">
                        		<input class="form-control" id="receiver" name="receiver"
		                        	   ...
		                        	   style="margin-left: 10px; width: 70%; float: left; height: 50px; width: 500px;"
		                        	   placeholder="사원 이름 검색">
		                        	   
								<!-- 채팅방 초대 버튼 -->
								<input type="button" id="inviteEmpBtn" class="btn" value="초대하기" 
									   style="display:inline; float: right; font-size: 20px;">
                            </div>
                            <br><br><br>
	                                   				...
	                                   				<c:if test="${empList.get(i).empId != EMP.empId}">
	                                   					<tr id="${empList.get(i).empId }" data-emptr="${empList.get(i).empId }" data-empnm="${empList.get(i).empNm }" class="checkTR">
															<td>
																...
																<span class="empNameInfo">${empList.get(i).empNm }</span>

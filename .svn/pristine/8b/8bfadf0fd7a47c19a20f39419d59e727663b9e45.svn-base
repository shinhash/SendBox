                                	...
                                	<c:forEach items="${MailList }" var="mail">
	                                     <tr class='listClass'>
	                                         ...
	                                         <td style="text-align : left;">
		                                         <a href="#" id="mailtitle" style="color : blue;">${mail.title}</a>
	                                         </td>
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="paginate_button page-item previous" id="dataTable_previous">
								                        ...
								                        <c:when test="${param.searchCondition != null}">
															<a href="/mail/notlist?searchCondition=${param.searchCondition }&searchKeyword=${param.searchKeyword }" aria-controls="dataTable"  class="page-link">
																<i class="fas fa-angle-double-left"></i>
															</a>
								                        </c:when>
							                        	</c:choose>
													...
													<li class="paginate_button page-item previous" id="dataTable_previous">
								                        ...
								                        <c:when test="${param.searchCondition != null}">
															<a href="/mail/notlist?pageIndex=${pagination.currentPageNo-1}&searchCondition=${param.searchCondition }&searchKeyword=${param.searchKeyword }" aria-controls="dataTable"  class="page-link">
																<i class="fas fa-angle-left"></i>
															</a>
								                        </c:when>
							                        	</c:choose>
											...
											<c:forEach begin="${pagination.getFirstPageNoOnPageList() }" end="${pagination.getLastPageNoOnPageList() }" step="1" var="i">
												<c:choose>
													...
													<c:choose>
								                        ...
								                        <c:when test="${param.searchCondition != null}">
															<li class="paginate_button page-item">
																<a href="/mail/notlist?pageIndex=${i}&searchCondition=${param.searchCondition }&searchKeyword=${param.searchKeyword }" aria-controls="dataTable"  class="page-link">${i }</a>
															</li>
								                        </c:when>
							                        	</c:choose>
													</c:otherwise>
											...
											<c:choose>
												...
												<c:otherwise>
													<li class="paginate_button page-item next" id="dataTable_next">
								                        ...
								                        <c:when test="${param.searchCondition != null}">
															<a href="/mail/notlist?pageIndex=${pagination.currentPageNo+1}&searchCondition=${param.searchCondition }&searchKeyword=${param.searchKeyword }" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link">
																<i class="fas fa-angle-right"></i>
															</a>
								                        </c:when>	
							                        	</c:choose>
													...
													<li class="paginate_button page-item next" id="dataTable_next">
								                        ...
								                        <c:when test="${param.searchCondition != null}">
															<a href="/mail/notlist?pageIndex=${pagination.getTotalPageCount()}&searchCondition=${param.searchCondition }&searchKeyword=${param.searchKeyword }" aria-controls="dataTable" data-dt-idx="2" tabindex="0" class="page-link">
																<i class="fas fa-angle-double-right"></i>
															</a>
								                        </c:when>
							                        	</c:choose>

...
<body data-editor="DecoupledDocumentEditor" data-collaboration="false">
	...
	<%-- 						<form:input path="typeId"  readonly="true"/> --%>
							...
							<td class="datatd" style="padding: 0px;" colspan="3">
								<table style="width: 100%; text-align: center;">
									...
									<tr>
										...
										<td style="border: 1px solid black;">${reportVo.empId }</td>
										<td style="background: lightgray; border: 1px solid black;">소속</td>
										<td style="border: 1px solid black;">${reportVo.deptName }</td>
									</tr>
									<tr>
										<td style="background: lightgray; border: 1px solid black;">직급</td>
										<td style="border: 1px solid black; ">${reportVo.jobtitleNm }</td>
										<td style="background: lightgray; border: 1px solid black;">이름</td>
										<td style="border: 1px solid black;">${reportVo.empNm }</td>
									</tr>
								</table>	
							</td>
						</tr>
						...
						<tr>
							...
							<td class="datatd" colspan="3"><form:input path="title"  readonly="true"/></td>
						</tr>

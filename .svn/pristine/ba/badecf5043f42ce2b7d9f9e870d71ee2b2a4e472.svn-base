	...
	<div id="demo" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item active">
				<!--가로-->
				<img class="d-block w-100" src="/images/commuguide1.jpg"
					alt="First slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>커뮤니티 목록 조회</h5>
					<p>즐겨찾기한 항목이 상단에 나타남</p>
				</div>
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/commuguide2.jpg"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>커뮤니티 게시판 리스트</h5>
					<p>오른쪽 상단에 즐겨찾기 버튼으로 즐겨찾기 추가, 취소 가능</p>
					<p>등록/수정/삭제/댓글 가능</p>
				</div>
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/freeBoardList.jpg"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>자유게시판 리스트</h5>
					<p>등록/수정/삭제/댓글 가능</p>
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/freeBoardDetail.jpg"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>자유게시판 조회</h5>
				</div>
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/commuguide3.jpg"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>내 커뮤니티 관리</h5>
				</div>

  	    	   ...
  	    	   var html =  "<tr>"
			  					+"<td>"
			  						+"<div class='col-sm-10 fileDiv'>"
			  							...
			  							+"<button type='button' class='btn btn-primary btnMinus' style='outline: 0; border: 0; margin-left: 5px;'>"
...
$(function() {
	...
	/* function initReportData(){
		$('#reportTitle').val('프로젝트 인원 보충의 건');
		var html = '<p>프로젝트 인원 부족으로 인한 인원 보충 요청드리오니, 검토 후 재가하여 주시기 바랍니다.</p><p>1. 목적 및 사유<br>&nbsp; 가. 프로젝트 인원 부족<br>&nbsp; 나. 인원 보충으로 인한 업무효율성 극대화</p><p>2. 내 &nbsp; &nbsp;역<br>&nbsp;가. 개발2팀 : 2명<br>&nbsp;나. 개발1팀 : 1명</p><p>※ 첨 &nbsp; &nbsp; 부 : 1. 진행 프로젝트 상황보고서 1부.<br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 2. 인원보충 명단 1부. &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 끝.</p>';
		$('div.editor').append(html);
	} */
			...
			<script>
				...
				<div class="tail">
					<table style="width : 100%; border : 1px solid black; border-top: none;" id="fileTable">
						<tr>
							<td rowspan="5" class="labeltd">첨부파일</td>
							<td>

	...
	<div id="demo" class="carousel slide" data-ride="carousel">
		<div class="carousel-inner">
			...
			<div class="carousel-item active">
				<!--가로-->
				<img class="d-block w-100" src="/images/mypage.JPG"
					alt="First slide">
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/updatemypage.JPG"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>마이페이지 수정</h5>
				</div>
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/attend.JPG"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>월별 근태조회</h5>
					<p>월별 엑셀 다운로드 가능</p>
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="/images/salary.JPG"
					alt="Second slide">
				<div class="carousel-caption d-none d-md-block">
					<h5>급여조회</h5>
				</div>

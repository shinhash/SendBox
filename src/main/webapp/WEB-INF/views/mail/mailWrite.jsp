		...
		$(document)
				.ready(
						function() {
							...
							$('#receiverDiv').on('click', '#receiverMinus', function() {
							...
							$('#receiverPlus')
									.on(
											...
											function() {
												...
												var html = '<br><input class="receiver" type="text" name="receiver" autofocus maxlength="30" minlength="1" style="margin-left: 10px; width: 30%; margin-top : 10px;">'
														+ '<button type="button" id="receiverMinus" style="margin-left: 5px; outline: 0; border: 0;">'
														+ '<i class="fas fa-fw fa-minus" style="color: black; font-size:10px;"></i>'
														+ '</button>';
												$(this).parent().append(html);

												$(this).parent().find('input[type=text]:last').autocomplete({
...
// 												alert($(this).parent().children('.receiver').val())
...
// 								checkSame();
		...
		function checkSame(){
			 var cnt = document.getElementsByName(receiver);	
			 alert(cnt)
		}
	</script>
<style>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid"  style="max-width: 90%;">
                    <!-- Page Heading -->
                    <!-- summernote -->
					<form action="/mailSend" method="post" enctype="multipart/form-data" name="mailfrm">
                    <table  width="100%" cellspacing="0">
                    	<tr>
                    		<td class="front">받는 사람
                    		<input type="hidden" id = "sender" name="sender" value="${EMP.empId }">
                    		<input type="hidden" id = "parentmailId" name="parentmailId" value="${param.mailSeq }">
                    		</td>
                    		<c:choose>
                    			<c:when test="${registerFlag=='1'}">
                    				<td>
                    				<input class="form-control" readonly id="receiver" name="receiver" value="${param.sender }@sendbox.com" autofocus maxlength="30" minlength="1" style="margin-left: 10px; width: 25%;">
                    				</td>
                    			</c:when>
                    			<c:when test="${registerFlag=='0'}">
                    				<td>
	                    			<div id="receiverDiv">
                    				<input class="receiver" type="text" id = "receiver" name="receiver" autofocus maxlength="30" minlength="1" style="margin-left: 10px; width: 30%;">
	                    			<button type="button" id="receiverPlus" style="outline: 0; border: 0;">
										<i class="fas fa-fw fa-plus" style="color: black; font-size:10px;"></i>
									</button>
	                    		</div>
                    				</td>
                    			</c:when>
                    	...
                    	<tr>
                    		...
                    		<c:choose>
                    			<c:when test="${registerFlag=='1'}">
                    				<td><input type="text" name="title" autofocus maxlength="30" minlength="1" style="margin-left: 10px; width: 90%;" value="re : "></td>
                    			</c:when>
                    			
                    			<c:when test="${registerFlag=='0'}">
		                    		<td><input type="text" name="title" autofocus maxlength="30" minlength="1" style="margin-left: 10px; width: 90%;"></td>
                    			</c:when>
                    		</c:choose>
                    	</tr>
						...
						<tr>
							...
							<td>
								<div id="fileDiv" class="col-sm-10">
									...
									<button type="button" id="btnPlus" style="outline: 0; border: 0;">
										<i class="fas fa-fw fa-plus" style="color: black; font-size:10px;"></i>
									</button>
								</div>
							</td>
						...
						<tr >
					 	...
					 	<br>
					 	<input type="button" id="insertBtn" class="btn btn-outline-secondary alamnBtnClass" data-alamntype="mail" value="전송" style="display:inline; float: right;">
